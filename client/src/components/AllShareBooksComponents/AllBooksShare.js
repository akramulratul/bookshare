...
import { Pagination } from "../AllBooksComponents/Pagination/Pagination";
...
const AllBooksShare = () => {
  ...
  const AllBooksShare = useSelector((state) => state.shareBooks);
